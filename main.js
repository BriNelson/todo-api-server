...
// Filter ToDo's
const filterDropdown = document.querySelector('#categorieFilter')
...
// Deletes list item
const fullListItem = document.querySelector('#toDoList')// ul saved as a variable
...
// Deletes category
const fullCategoryList = document.querySelector('#list2')
